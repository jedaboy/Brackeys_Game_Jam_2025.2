...
namespace ScriptBoy.EButtonEditor
{
    class EButtonDrawer
    {
        ...
        public EButtonDrawer(object[] targets)
        {
            BindingFlags flags =
            ...
            for (int i = 0; i < methods.Length; i++)
            {
                ...
                for (int j = 0; j < attributeCount; j++)
                {
                    ...
                    if (attributeType == typeof(EButtonAttribute))
                    {
                        ...
                        actionList.Add(new DrawButton(text, methodInfo, targets));
                    }
        ...
        class DrawButton : UIAction
        {
            ...
            public DrawButton(string text, MethodInfo methodInfo, object[] targets)
            {
